...
! function(a, e, t, i) {
    ...
    var o = function(r, o) {
            var c, p = a.extend({}, a.fn.avalancheSlider.tmsOpts, o),
                b = a(r),
                y = this,
                x = p.fulscreen ? a(t).width() : p.fullwidth ? p.scaleUnder : parseFloat(b.data("width") ? b.data("width") : b.css("width")),
                S = p.fulscreen ? a(t).height() : parseFloat(b.data("height") ? b.data("height") : b.css("height")),
                O = b.find(".tms-slides"),
                F = O.children("li:first-child").addClass("active"),
                T = [];
            if (O.children(".tms-slide").each(function(e) {
                    e++, a(this).attr("id", "tms-slide-" + e), T.push(a(this).attr("id")), p.carousel || a(this).not(".active").css(H ? {
                        transition: "none",
            ...
            if (p.navPagination && O.children().length > 1) {
                ...
                var B = b.find("bullets" === p.paginationType ? ".tms-bullet-nav" : ".tms-thumb-nav");
                B.each(function() {
                    a(this).on("click", function() {
                        return F = b.find("li.active"), a(this).hasClass("active") ? !1 : (p.autoAdvance && b.data("loaded") && y.resetSlideshow(), parseFloat(a(this).data("index")) > parseFloat(A.find(".active").data("index")) ? y.slideTo(a(this).data("index"), "next") : y.slideTo(a(this).data("index"), "prev"), !1)
                    })
                }), A.find(".tms-bullet-nav:first-child").addClass("active"), p.lazyLoad && A.css({
                    display: "block"
                })
            }
            if (p.navKeyboard && O.children().length > 1) {
                var V = [];
                a(e).on("keydown", function(a) {
                    return V[a.keyCode] = !0, V[37] && V[39] ? !1 : (V[37] ? (p.autoAdvance && b.data("loaded") && y.resetSlideshow(), p.lazyLoad ? y.prevSlide() : b.data("loaded") && y.prevSlide()) : V[39] && (p.autoAdvance && b.data("loaded") && y.resetSlideshow(), p.lazyLoad ? y.nextSlide() : b.data("loaded") && y.nextSlide()), i)
                }).on("keyup", function(a) {
                    V[a.keyCode] = !1
                })
            }
            b.swipeIt({
                ...
                b.data("first-load") && (x = p.fulscreen ? a(t).width() : p.fullwidth ? p.scaleUnder : parseFloat(b.data("width") ? b.data("width") : b.css("width")), S = p.fulscreen ? a(t).height() : parseFloat(b.data("height") ? b.data("height") : b.css("height")), b.data("refW", x).data("refH", S).data("carousel-height", S));
                var e = b.find("li.active, li.target");
                p.carousel && p.carouselVisible > 1 ? O.children(".tms-slide").each(function() {
                    v(a(this), p)
                }) : v(e, p), m(b, p), b.addClass("resizing"), I(function() {
                    b.removeClass("resizing")
                }, 300, "resize")
            }), b.parent().hasClass("tm-slider-parallax-container") && p.parallax ? (a(t).on("scroll", function() {
                l(b, p)
            }), d(b, p)) : !b.parent().hasClass("tm-slider-parallax-container") && p.parallax && console.log("Add the class tm-slider-parallax-container to slider parent"), b.data("setup", !1).data("loaded", !1).data("first-load", !0).data("transitioning", !1).data("refW", x).data("refH", S).data("carousel-height", S), n(b), m(b, p), p.onSetup && p.onSetup();
            var P, M, L, E, D, R, U, W = null,
                Q = null;
            y.initSlideshow = function() {
                return P || O.children().length < 2 ? !1 : (p.autoAdvance = !0, !X && p.pauseOnHover && (O.on("mouseleave ", y.resumeSlideshow), O.on("mouseenter ", y.pauseSlideshow)), p.showProgressBar && (U = a("<div>").addClass("tms-progress-bar").appendTo(b)), y.startSlideshow(), Z(p.interval), M = (new Date).getTime(), D = p.interval, p.onSlideshowStart && p.onSlideshowStart(), i)
            }, y.startSlideshow = function(a) {
                a = a ? E : p.interval, P = setInterval(function() {
                    a !== p.interval && (clearInterval(P), a = p.interval, D = p.interval, y.startSlideshow()), M = (new Date).getTime(), i !== U && U.css({
                        transition: "none",
                        width: "0px"
                    }), Z(p.interval), y.nextSlide()
                }, a)
            }, y.pauseSlideshow = function() {
                return R || !P ? !1 : (clearInterval(P), L = (new Date).getTime(), E = 50 > D - (L - M) ? 50 : D - (L - M), D = 0 === D ? p.interval : E, i !== U && U.stop().css({
                    width: U.width() + "px"
                }), R = !0, p.onSlideshowPause && p.onSlideshowPause(), i)
            }, y.resumeSlideshow = function() {
                return R ? (clearInterval(P), b.data("ssPaused", !1), M = (new Date).getTime(), Z(E), y.startSlideshow(E), R = !1, i) : !1
            }, y.resetSlideshow = function() {
                return P ? (clearInterval(P), i !== U && U.css({
                    transition: "none",
                    width: "0px"
                }), Z(p.interval), M = (new Date).getTime(), E = p.interval, D = p.interval, y.startSlideshow(p.interval), i) : !1
            }, y.endSlideshow = function() {
                return P ? (clearInterval(P), P = "", R = !1, !X && p.pauseOnHover && (O.off("mouseleave ", y.resumeSlideshow), O.off("mouseenter ", y.pauseSlideshow)), i !== U && U.remove(), p.onSlideshowEnd && p.onSlideshowEnd(), i) : !1
            };
            var Z = function(a) {
            ...
            y.nextSlide = function() {
                ...
                if (e = a.inArray(t, T) + 1 === 0 ? 1 : a.inArray(t, T) + 1, p.carousel && p.carouselVisible > 1) {
                    var i = f(b, p);
                ...
                F = b.find("li.active");
                var t = T[a.inArray(F.attr("id"), T) - 1];
                if (e = a.inArray(t, T) + 1 === 0 ? O.children().length : a.inArray(t, T) + 1, p.carousel && p.carouselVisible > 1) {
                    var i = f(b, p);
                ...
                s.addClass("target").css({
                    ...
                    zIndex: 1
                }), p.animation = s.data("animation") ? s.data("animation") : c;
                var r = "slide" === p.animation || "slideLeftRight" === p.animation ? i : 0,
                    o = "slideTopBottom" === p.animation ? n : 0;
                r *= p.carousel ? e - 1 : 1;
                var l = "scaleIn" === p.animation ? 1 - p.scaleFactor : "scaleOut" === p.animation ? 1 + p.scaleFactor : 1;
                b.removeClass("tms-nav-dark"), s.is("[data-nav-dark]") ? (b.addClass("tms-nav-dark"), b.is("[data-featured-slider]") && a("header").addClass("nav-dark")) : b.is("[data-featured-slider]") && a("header").removeClass("nav-dark"), w(s, p), (s.children("img").data("loaded") || !s.children("img").length) && v(s, p), m(b, p, s), t || (t = "next"), t = p.carousel ? 1 : "next" === t ? 1 : -1;
                var d = f(b, p);
                H ? p.carousel ? u(O, 1, -(r / d) * t, 0, 0, 0, 0, 0, 1, "50%", "50%", p.speed, 0, Y[p.easing], p) : (s.css({
                    opacity: 0,
                    transition: "none",
                    transform: "translate3d(" + r * t + "px," + o * t + "px, 0) scale3d(" + l + ", " + l + ", " + l + ")"
                }), clearTimeout(Q), Q = setTimeout(function() {
                    u(F, 1, -r * t, -o * t, 0, 0, 0, 0, l, "50%", "50%", p.speed, 0, Y[p.easing], p), u(s, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", p.speed, 0, Y[p.easing], p)
                }, 50)) : p.carousel ? (b.data("transitioning", !0), O.animate({
                    opacity: 1,
                    left: -(r / d) * t + "px"
        ...
        u = function(e, t, i, n, s, r, o, l, d, c, u, p, g, f, m) {
            ...
            var b = {};
            b.transform = "translate3d(" + i + "px, " + n + "px, " + s + "px) rotateX(" + r + "deg) rotateY(" + o + "deg) rotateZ(" + l + "deg) scale3d(" + d + ", " + d + ", " + d + ")", b.transitionProperty = B + ", opacity", b.transformOrigin = c + " " + u + " 0", b.transitionDuration = p + "ms", b.transitionDelay = g + "ms", b.transitionTimingFunction = f, b.visibility = "visible", b.opacity = t, e.css(b).on(V, function(e) {
                e.stopPropagation(), a(this).off(V), (a(this).hasClass("target") || a(this).hasClass("tms-slides") && !v.data("animate-first-slide")) && h(v, m), a(this).hasClass("tms-caption") && a(this).css({
                    transition: ""
        ...
        p = function(e, t) {
            e.find(".tms-caption").not(".no-transition").show().each(function() {
                var e = a(this),
                    ...
                    o = a(this).data("e") ? Y[e.data("e")] : Y[t.easing],
                    l = null;
                H ? (clearTimeout(l), l = setTimeout(function() {
        ...
        v = function(e, i) {
          ...
          // To handle video size for mobile content (3rem)
          if($("body").hasClass("mobile")) {
            marginBottom = parseInt((window.getComputedStyle(document.getElementsByTagName('html')[0])['fontSize']))*3+50;
          }

            var n = e.closest(".tm-slider-container, .featured-media"),
                s = n.parent().width(),
                r = i.fsUseHeightOf ? i.fsUseHeightOf.height() : (a(t).height()-marginBottom),
                o = n.data("refW"),
                l = n.data("refH"),
                ...
                h = i.fullscreen ? r - c : i.carousel && i.carouselVisible > 1 && !i.carouselScaleHeight ? l : i.fullwidth && s / d > l ? l - c : s / d - c,
                p = h > i.scaleMinHeight ? !1 : !0,
                g = p ? u / i.scaleMinHeight : u / h,
                f = i.carouselScaleHeight && 1 === i.carouselVisible ? !0 : !1,
                m = i.forceFit || e.is("[data-force-fit]");
            if (n.data("newSW", u), n.data("newSH", h), i.carousel) {
                var v = null;
                ...
                height: n.height() + "px"
            }), h = h > i.scaleMinHeight || "auto" === i.scaleMinHeight ? h : i.scaleMinHeight, n.data("newSH", h);
            if (!n.data("setup") || i.carousel && i.carouselVisible > 1) return !1;
            var w = e.is("[data-image]") ? "image" : "video",
            ...
            e.find("img, iframe, video, .mejs-container").not(".tms-caption img, .tms-caption iframe, .tms-caption video").each(function() {
                var t, n, s;
                if ("image" === w ? (t = a(this).width(), n = a(this).height()) : "video" === w && ((!i.respectRatio && !y || i.fullscreen && !y) && e.addClass("tms-video-no-ratio"), y ? (t = i.fullwidth ? h * x : u, n = i.fullwidth ? h : u / x) : (t = a(this).attr("width") && u > a(this).attr("width") ? a(this).attr("width") : u, n = t / x)), s = t / n, "image" === w && i.fullscreen || m || "video" === w && y) {
                    ...
                    a(this).css(g > s ? {
                        ...
                        width: !i.fullwidth || m || y ? Math.round(h * s) + "px" : "auto",
                        height: h + "px",
                        top: 0,
                        left: Math.round(-((h * s - u) / 2)) + "px"
                    })
                } else "video" === w && a(this).css({
            ...
            return !t.captionScaling || t.carouselVisible > 1 ? !1 : (e.find(".tms-caption").each(function() {
                if (!a(this).is("[data-no-scale]")) {
                    ...
                    e.find("img, iframe, video").length && (C = s * (d / o) > d ? d : s * (d / o) > s ? s : s * (d / o)), e.css(e.find("img").length || e.find("iframe, video").length ? {
                        ...
                        paddingBottom: s * (h / o) > h ? h : s * (h / o) + "px",
                        paddingLeft: s * (p / o) > p ? p : s * (p / o) + "px",
                        ...
                        borderRightWidth: s * (w / o) > w ? w : Math.ceil(s * (w / o)) + "px",
                        borderBottomWidth: s * (y / o) > y ? y : Math.ceil(s * (y / o)) + "px",
        ...
        F = function(n, s) {
            ...
            if (i !== r && r.indexOf("youtu") > -1) {
                ...
                g && s.autoPlay && (p.load(), p.autoplay = !0), n.parent().is("[data-video-bkg]") && (p.muted = s.muteBkgVideo), s.replayOnEnd && (p.loop = !0)
            }
        },
        I = function() {
            var a = {};
